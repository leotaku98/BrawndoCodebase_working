...
public class ConcreteOrder implements Order {
    ...
    public ConcreteOrder(int id, LocalDateTime date, double discountRate, int discountThreshold, int customerID){
        this.id = id;
        this.date = date;
    ...
    public ConcreteOrder(int id, LocalDateTime date, double discountRate, int customerID) {
        this.id = id;
        this.date = date;
        this.discountRate = discountRate;
        this.customerID = customerID;
    ...
    @Override
    public Order copy() {
        Order copy = new ConcreteOrder(id, date, discountRate, customerID);
...
//        return sb.toString();
    ...
    public double getTotalCost() {
        return orderVisitor.visitTotalCost(this);
